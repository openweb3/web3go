...
func (c *RpcParityClient) TransactionsLimit() (val uint, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_transactionsLimit")
	return
}
...
func (c *RpcParityClient) ExtraData() (val []byte, err error) {
	...
	err = c.core.CallContext(context.Background(), &_val, "parity_extraData")
	val = ([]byte)(_val)
	return
}
...
func (c *RpcParityClient) GasFloorTarget() (val *big.Int, err error) {
	...
	err = c.core.CallContext(context.Background(), &_val, "parity_gasFloorTarget")
	val = (*big.Int)(_val)
	return
}
...
func (c *RpcParityClient) GasCeilTarget() (val *big.Int, err error) {
	var _val *hexutil.Big
	err = c.core.CallContext(context.Background(), &_val, "parity_gasCeilTarget")
	val = (*big.Int)(_val)
	return
}
...
func (c *RpcParityClient) MinGasPrice() (val *big.Int, err error) {
	var _val *hexutil.Big
	err = c.core.CallContext(context.Background(), &_val, "parity_minGasPrice")
	val = (*big.Int)(_val)
	return
}
...
func (c *RpcParityClient) DefaultExtraData() (val []byte, err error) {
	var _val hexutil.Bytes
	err = c.core.CallContext(context.Background(), &_val, "parity_defaultExtraData")
	val = ([]byte)(_val)
	return
}
...
func (c *RpcParityClient) GasPriceHistogram() (val types.Histogram, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_gasPriceHistogram")
	return
}
...
func (c *RpcParityClient) UnsignedTransactionsCount() (val uint, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_unsignedTransactionsCount")
	return
}
...
func (c *RpcParityClient) GenerateSecretPhrase() (val string, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_generateSecretPhrase")
	return
}
...
func (c *RpcParityClient) PhraseToAddress(phrase string) (val common.Address, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_phraseToAddress", phrase)
	return
}

/// Returns the value of the registrar for this network.
func (c *RpcParityClient) RegistryAddress() (val *common.Address, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_registryAddress")
	return
}
...
func (c *RpcParityClient) ListAccounts(count uint64, after *common.Address, blockNumber *types.BlockNumberOrHash) (val []common.Address, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_listAccounts", count, after, blockNumber)
	return
}
...
func (c *RpcParityClient) ListStorageKeys(address common.Address, count uint64, after *common.Hash, blockNumber *types.BlockNumberOrHash) (val []common.Hash, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_listStorageKeys", address, count, after, blockNumber)
	return
}
...
func (c *RpcParityClient) EncryptMessage(key string, phrase []byte) (val []byte, err error) {
	...
	var _val hexutil.Bytes
	err = c.core.CallContext(context.Background(), &_val, "parity_encryptMessage", key, _phrase)
	val = ([]byte)(_val)
	return
}
...
func (c *RpcParityClient) PendingTransactions(limit *uint, filter *types.TransactionFilter) (val []types.Transaction, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_pendingTransactions", limit, filter)
	return
}
...
func (c *RpcParityClient) AllTransactions() (val []types.Transaction, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_allTransactions")
	return
}
...
func (c *RpcParityClient) AllTransactionHashes() (val []common.Hash, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_allTransactionHashes")
	return
}
...
func (c *RpcParityClient) FutureTransactions() (val []types.Transaction, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_futureTransactions")
	return
}
...
func (c *RpcParityClient) PendingTransactionsStats() (val map[common.Hash](types.TransactionStats), err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_pendingTransactionsStats")
	return
}
...
func (c *RpcParityClient) LocalTransactions() (val map[common.Hash]types.LocalTransactionStatus, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_localTransactions")
	return
}
...
func (c *RpcParityClient) WsUrl() (val string, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_wsUrl")
	return
}
...
func (c *RpcParityClient) NextNonce(address common.Address) (val *big.Int, err error) {
	var _val *hexutil.Big
	err = c.core.CallContext(context.Background(), &_val, "parity_nextNonce", address)
	val = (*big.Int)(_val)
	return
}
...
func (c *RpcParityClient) Mode() (val string, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_mode")
	return
}
...
func (c *RpcParityClient) Chain() (val string, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_chain")
	return
}

/// Get the enode of this node.
func (c *RpcParityClient) Enode() (val string, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_enode")
	return
}

/// Get the current chain status.
func (c *RpcParityClient) ChainStatus() (val types.ChainStatus, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_chainStatus")
	return
}

/// Get node kind info.
func (c *RpcParityClient) NodeKind() (val types.NodeKind, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_nodeKind")
	return
}
...
func (c *RpcParityClient) BlockHeader(number *types.BlockNumberOrHash) (val types.RichHeader, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_getBlockHeaderByNumber", number)
	return
}
...
func (c *RpcParityClient) BlockReceipts(number *types.BlockNumberOrHash) (val []types.Receipt, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_getBlockReceipts", number)
	return
}
...
func (c *RpcParityClient) Call(requests []types.CallRequest, num *types.BlockNumberOrHash) (val [][]byte, err error) {
	var _val []hexutil.Bytes
	err = c.core.CallContext(context.Background(), &_val, "parity_call", requests, num)
...
func (c *RpcParityClient) SubmitWorkDetail(nonce string, powHash common.Hash, mixHash common.Hash) (val common.Hash, err error) {
	err = c.core.CallContext(context.Background(), &val, "parity_submitWorkDetail", nonce, powHash, mixHash)
	return
}
...
func (c *RpcParityClient) Status() (err error) {
	err = c.core.CallContext(context.Background(), &[]interface{}{}, "parity_nodeStatus")
	return
}
...
func (c *RpcParityClient) VerifySignature(isPrefixed bool, message []byte, r common.Hash, s common.Hash, v uint64) (val types.RecoveredAccount, err error) {
	...
	_v := (hexutil.Uint64)(v)
	err = c.core.CallContext(context.Background(), &val, "parity_verifySignature", isPrefixed, _message, r, s, _v)
	return
}
