...
// ToClientForContract returns ClientForContract for use by abi-binding struct generated by abigen.
...
func (c *Client) ToClientForContract() *ClientForContract {
	return NewClientForContract(c)
}
